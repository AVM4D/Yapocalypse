...
template <> constexpr inline auto AnimatedBackground::qt_create_metaobjectdata<qt_meta_tag_ZN18AnimatedBackgroundE_t>()
{
    ...
    return QtMocHelpers::metaObjectData<AnimatedBackground, qt_meta_tag_ZN18AnimatedBackgroundE_t>(QMC::MetaObjectFlag{}, qt_stringData,
            qt_methods, qt_properties, qt_enums);
}
Q_CONSTINIT const QMetaObject AnimatedBackground::staticMetaObject = { {
    QMetaObject::SuperData::link<QWidget::staticMetaObject>(),
    qt_staticMetaObjectStaticContent<qt_meta_tag_ZN18AnimatedBackgroundE_t>.stringdata,
    qt_staticMetaObjectStaticContent<qt_meta_tag_ZN18AnimatedBackgroundE_t>.data,
    qt_static_metacall,
    nullptr,
    qt_staticMetaObjectRelocatingContent<qt_meta_tag_ZN18AnimatedBackgroundE_t>.metaTypes,
    nullptr
} };
...
void *AnimatedBackground::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_staticMetaObjectStaticContent<qt_meta_tag_ZN18AnimatedBackgroundE_t>.strings))
